    ...
    <div className="w-full space-y-10">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-[#45515e] mt-3 text-lg font-medium">Оценка релевантности и фактологии</p>
          </div>
                    ...
                    {(() => {
                      ...
                      return (
                        <div className="text-left min-w-0 overflow-hidden">
                          ...
                          <div className="text-xs text-[#8e8e93] truncate leading-tight">{namePart}</div>
                        </div>
                      );
                    })()}
                  </SelectTrigger>
                      ...
                      return (
                        <SelectItem key={scan.value} value={scan.value}>
                          <div>
                            ...
                            <div className="text-xs text-[#8e8e93]">{namePart}</div>
                          </div>
                        </SelectItem>
                      );
                    })}
            ...
            {data?.allScans && data.allScans.length > 0 && (
              <div className="flex gap-2">
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 rounded-lg bg-[#eff6ff] border border-[#bfdbfe] text-[#2563eb] hover:bg-[#dbeafe] hover:text-[#1d4ed8] transition-all text-sm font-medium"
                >
                  <Download className="w-4 h-4" /> Отчёт MD
                </button>
                <button
                  onClick={() => downloadFile('csv')}
                  className="flex items-center gap-2 px-4 py-2 rounded-lg bg-[#f2f3f5] border border-[#e5e7eb] text-[#45515e] hover:bg-[#e5e7eb] hover:text-[#222222] transition-all text-sm font-medium"
                >
                        ...
                        <AccordionTrigger className="hover:no-underline py-6 px-2 text-[#222222] hover:text-[#45515e] transition-colors">
                            <div className="flex items-center justify-between w-full pr-4 text-left">
                                <div className="space-y-2">
                                    ...
                                    <div className="flex gap-2">
                                        <Badge variant="outline" className="bg-[#f2f3f5] text-[#45515e] font-medium border-[#e5e7eb] px-2 py-0.5 text-sm">{m.category}</Badge>
                                        <Badge variant="outline" className="bg-[#f2f3f5] text-[#45515e] font-medium border-[#e5e7eb] px-2 py-0.5 text-sm">{m.intent}</Badge>
                                    </div>
                                </div>
